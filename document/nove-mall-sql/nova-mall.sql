...
CREATE TABLE `pms_member_price` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=453 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='商品会员价格表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pms_product_attribute_value` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=562 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='存储产品参数信息的表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pms_product_operate_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='商品操作日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pms_product_operate_log` VALUES (1,27,2699.00,2699.00,NULL,NULL,2699,2699,0,0,'admin','2026-06-06 19:02:03',NULL,NULL,NULL,NULL),(2,27,2699.00,2699.00,NULL,NULL,2699,2655,0,0,'admin','2026-06-06 19:02:55',NULL,NULL,NULL,NULL),(3,27,2699.00,2699.00,NULL,NULL,2655,2655,0,0,'admin','2026-06-06 19:33:38',1,0,'',''),(4,27,2699.00,3000.00,NULL,NULL,2655,2655,0,0,'admin','2026-06-06 19:35:37',0,0,NULL,NULL),(5,27,3000.00,3000.00,NULL,NULL,2655,2655,0,0,'admin','2026-06-06 19:37:56',0,0,NULL,NULL),(6,27,3000.00,3000.00,NULL,NULL,2655,2655,0,0,'admin','2026-06-06 19:39:13',0,0,NULL,NULL),(7,27,3000.00,3000.00,NULL,NULL,2655,2655,0,20,'admin','2026-06-06 19:40:13',0,0,NULL,NULL),(8,27,3000.00,3000.00,NULL,NULL,2655,2655,20,20,'admin','2026-06-06 19:42:07',0,0,NULL,NULL),(9,27,3000.00,3000.00,NULL,NULL,2655,2655,20,20,'admin','2026-06-06 19:43:01',0,0,NULL,NULL);
...
CREATE TABLE `pms_product_vertify_record` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='商品审核记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pms_product_vertify_record` VALUES (1,1,'2018-04-27 16:36:41','test',1,'验证通过'),(2,2,'2018-04-27 16:36:41','test',1,'验证通过'),(3,27,'2026-06-06 00:24:36','admin',1,''),(4,27,'2026-06-06 00:24:41','admin',0,''),(5,27,'2026-06-06 00:28:19','admin',1,''),(6,28,'2026-06-06 00:29:20','admin',1,'给予通过'),(7,27,'2026-06-06 01:13:28','admin',0,''),(8,27,'2026-06-06 16:16:42','admin',1,''),(9,27,'2026-06-06 18:34:05','admin',0,''),(10,27,'2026-06-06 18:52:35','admin',1,''),(11,27,'2026-06-06 18:56:39','admin',0,''),(12,27,'2026-06-06 19:01:43','admin',1,''),(13,27,'2026-06-06 19:33:38','admin',0,'');
...
CREATE TABLE `sms_coupon` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='优惠券表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sms_coupon` VALUES (27,0,'全品类通用券',0,94,10.00,10,100.00,'2022-11-08 00:00:00','2023-11-30 00:00:00',0,NULL,100,0,6,'2022-11-08 00:00:00',NULL,NULL),(28,0,'手机分类专用券',0,995,100.00,5,1000.00,'2022-11-08 00:00:00','2023-11-30 00:00:00',1,NULL,1000,0,5,'2022-11-08 00:00:00',NULL,NULL),(29,0,'苹果手机专用券',0,998,600.00,1,4000.00,'2022-11-08 00:00:00','2023-11-30 00:00:00',2,NULL,1000,0,2,'2022-11-08 00:00:00',NULL,NULL),(30,0,'小米手机专用券',0,998,200.00,1,2000.00,'2022-11-08 00:00:00','2023-11-30 00:00:00',2,NULL,1000,0,2,'2022-11-08 00:00:00',NULL,NULL),(31,0,'限时优惠券',0,999,20.00,5,500.00,'2022-12-01 00:00:00','2022-12-22 00:00:00',0,NULL,1000,0,1,'2022-12-23 00:00:00',NULL,NULL),(32,0,'测试优惠券-MP',NULL,100,10.00,NULL,100.00,NULL,NULL,NULL,NULL,100,0,0,NULL,NULL,NULL),(34,0,'测试优惠券-MP',NULL,100,10.00,NULL,100.00,NULL,NULL,NULL,NULL,100,0,0,NULL,NULL,NULL);
...
INSERT INTO `ums_admin` VALUES (1,'test','$2a$10$NZ5o7r2E.ayT2ZoxgjlI.eJ6OEYqjH7INR/F.mXDbjZJi9HF0YCVG','https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_02.png','test@qq.com','测试账号',NULL,'2018-09-29 13:55:30','2018-09-29 13:55:39',1),(3,'admin','$2a$10$.E1FokumK5GIXWgKlg.Hc.i/0/2.qdAwYFL1zc5QHdyzpXOr38RZO','https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_01.png','admin@163.com','系统管理员','系统管理员','2018-10-08 13:32:47','2019-04-20 12:45:16',1),(6,'productAdmin','$2a$10$6/.J.p.6Bhn7ic4GfoB5D.pGd7xSiD1a9M6ht6yO0fxzlKJPjRAGm','https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_03.png','product@qq.com','商品管理员','只有商品权限','2020-02-07 16:15:08',NULL,1),(7,'orderAdmin','$2a$10$UqEhA9UZXjHHA3B.L9wNG.6aerrBjC6WHTtbv1FdvYPUI.7lkL6E.','https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_04.png','order@qq.com','订单管理员','只有订单管理权限','2020-02-07 16:15:50',NULL,1),(8,'test123','$2a$10$M1qJguEzwoAN0la7PB8UO.HOGe1xZGku7xw1iTaUUpY0ZVRCxrxoO','string','abc@qq.com','string','string','2022-08-07 14:45:42',NULL,1),(9,'test256','$2a$10$kTMBrt8mkXcO8T4eHThFWOf3KuNK6tqevkiAf4YbtXtaCJ6ocYkJa','string','abc@qq.com','string','string','2022-08-07 14:52:57',NULL,1),(10,'test1267','$2a$10$VUywDhXVPY13YZxMD/uPWeDqkzSozN7o8u/3MX6sBig2NK2VaTJZ2',NULL,'test1267@qq.com','test1267','test1267','2023-01-04 16:13:34',NULL,1),(11,'productAdmin2','$2a$10$9gCH9RpL.qPvxflJVZYb1OSKUSd.i0mxlPUai1x47LLcaxfNuORdC',NULL,'gkd@edu.com','Su',NULL,'2026-06-04 23:07:42',NULL,1);
...
-- Dump completed on 2026-06-07 16:21:47
