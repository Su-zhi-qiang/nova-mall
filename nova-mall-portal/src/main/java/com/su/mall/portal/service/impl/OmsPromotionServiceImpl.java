        ...
        for (Map.Entry<Long, List<OmsCartItem>> entry : productCartMap.entrySet()) {
            ...
            for (OmsCartItem item : flashItemList) {
                ...
                PromotionContext context = PromotionContext.builder()
                        ...
                        .build();
                CartPromotionItem cartPromotionItem = flashStrategy != null
                        ? flashStrategy.calculatePromotion(context)
                        : promotionStrategyFactory.getStrategy(0).calculatePromotion(context);
                if (cartPromotionItem != null) {
                    cartPromotionItemList.add(cartPromotionItem);
                }
            }
